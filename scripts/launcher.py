...
Запускает arduino_to_flprog_GLOBAL_COMPLETE.py из той же папки (scripts).
При сборке exe: script_dir = корень/scripts.
"""
...
def main():
    ...
    if not os.path.isfile(main_script):
        ...
        _show_error(
            ...
            "Положите exe и папку scripts в одну папку."
        )
        sys.exit(1)
